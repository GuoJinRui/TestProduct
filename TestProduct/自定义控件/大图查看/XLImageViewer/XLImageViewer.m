...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([_imageUrls[indexPath.row] isKindOfClass:[NSString class]]) {
        cell.imageUrl = _imageUrls[indexPath.row];
    }
    if ([_imageUrls[indexPath.row] isKindOfClass:[UIImage class]]) {
        cell.localImage = _imageUrls[indexPath.row];
    }
    //添加回调
    __weak typeof (self)weekSelf = self;
...
- (void)showLocalImagePathes:(NSArray <NSString *>*)imagePathes index:(NSInteger)index fromImageContainer:(UIView *)imageContainer {
...
- (void)showLocalImages:(NSArray <UIImage *>*)images index:(NSInteger)index fromImageContainer:(UIView*)imageContainer
{
    _showNetImages = false;
    //设置图片容器
